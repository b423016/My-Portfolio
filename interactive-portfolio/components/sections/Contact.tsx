...
import { Mail, MapPin, Github, Linkedin, Send, MessageCircle, Calendar, ExternalLink, FileText } from 'lucide-react';
          ...
          >
            ...
            <div className="bg-gradient-to-br from-purple-900/30 to-blue-900/30 backdrop-blur-xl rounded-3xl p-8 border border-white/10">
              ...
              <div className="space-y-3">
                <motion.a
                  href="https://drive.google.com/file/d/1nKLoHiWHRDQ1crKXyuEHiUQauU8ELSPK/view?usp=sharing"
                  target="_blank"
                  rel="noopener noreferrer"
